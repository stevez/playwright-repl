/**
 * E2E test fixtures for the preferences page.
 * Launches Chromium with the extension loaded and provides a fresh
 * preferences page with JS coverage tracking per test.
 */
...
export const test = base.extend<
  { prefsPage: Page; extensionId: string },
...
>({
  ...
  prefsPage: async ({ extensionContext }, use, testInfo) => {
