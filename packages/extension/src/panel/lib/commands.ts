...
export const COMMANDS: Record<string, CommandInfo> = {
    ...
    'close':                { desc: 'Close the browser' },
    'close-all':            { desc: 'Close all sessions' },
    ...
    'install-browser':      { desc: 'Install browser' },
    'kill-all':             { desc: 'Kill all daemons' },
    'list':                 { desc: 'List sessions' },
