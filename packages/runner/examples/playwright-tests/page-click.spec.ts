...
async function detachFrame(page: any, frameId: string) {
  await page.evaluate((fid: string) => document.getElementById(fid)!.remove(), frameId);
}
...
it('should click shadow root button', async ({ page }) => {
  await page.setContent(`
    <my-button>
